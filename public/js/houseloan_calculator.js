...
$(function() {
    $("#business_calc").on("click", function() {
        ...
        0 <= button.attr("class").indexOf("text-gray-600") && (button.removeClass("text-gray-600 hover:bg-gray-100").addClass("bg-blue-500 text-white").parent().siblings(".tab").find("button").removeClass("bg-blue-500 text-white").addClass("text-gray-600 hover:bg-gray-100"), $("#business_sum_line").show(), $("#business_rate_select_line").show(), $("#business_rate_value_line").show(), $("#PAF_sum_line").hide(), $("#PAF_rate_line").hide(), $("#business_interest_total_debx").hide(), $("#PAF_interest_total_debx").hide(), $("#business_interest_total_debj").hide(),
            $("#PAF_interest_total_debj").hide(), $("#business_atc_recmd_mod").show(), $("#PAF_atc_recmd_mod").hide(), loanType = 0)
    });
    $("#PAF_calc").on("click", function() {
        var button = $(this).find("button");
        0 <= button.attr("class").indexOf("text-gray-600") && (button.removeClass("text-gray-600 hover:bg-gray-100").addClass("bg-blue-500 text-white").parent().siblings(".tab").find("button").removeClass("bg-blue-500 text-white").addClass("text-gray-600 hover:bg-gray-100"), $("#PAF_sum_line").show(), $("#PAF_rate_line").show(), $("#business_sum_line").hide(), $("#business_rate_select_line").hide(), $("#business_rate_value_line").hide(), $("#business_interest_total_debx").hide(),
    ...
    $("#mix_calc").on("click", function() {
        var button = $(this).find("button");
        0 <= button.attr("class").indexOf("text-gray-600") && (button.removeClass("text-gray-600 hover:bg-gray-100").addClass("bg-blue-500 text-white").parent().siblings(".tab").find("button").removeClass("bg-blue-500 text-white").addClass("text-gray-600 hover:bg-gray-100"), $("#business_sum_line").show(), $("#business_rate_select_line").show(), $("#business_rate_value_line").show(),
    ...
    $(".result-tab").on("click", function() {
        ...
        if (0 <= link.attr("class").indexOf("text-gray-600")) {
            link.removeClass("text-gray-600 hover:bg-white hover:shadow-sm").addClass("bg-white shadow-sm text-blue-600 font-semibold").parent().siblings(".result-tab").find("a").removeClass("bg-white shadow-sm text-blue-600 font-semibold").addClass("text-gray-600 hover:bg-white hover:shadow-sm");
    ...
    $("#calculate").on("click", function() {
        if (userInputCheck()) {
            // Show loading state
            $("#calculate-text").addClass("hidden");
            $("#calculate-loading").removeClass("hidden");
            $("#calculate").prop("disabled", true).addClass("opacity-75 cursor-not-allowed");
            ...
            setTimeout(function() {
                ...
                // Reset button state
                $("#calculate-text").removeClass("hidden");
                $("#calculate-loading").addClass("hidden");
                $("#calculate").prop("disabled", false).removeClass("opacity-75 cursor-not-allowed");
            }, 500);
        }
    });
...
function calculate() {
    ...
    var tab = $("#result_tab_" + a);
    tab.find("a").removeClass("text-gray-600 hover:bg-white hover:shadow-sm").addClass("bg-white shadow-sm text-blue-600 font-semibold");
    tab.siblings(".result-tab").find("a").removeClass("bg-white shadow-sm text-blue-600 font-semibold").addClass("text-gray-600 hover:bg-white hover:shadow-sm");
    $("#result_data_" + a).show().siblings(".result-data").hide();
    showResultTabID = a
}
